...
def perfectCity(departure, destination):
    ...
    #print(delta_x_start, delta_y_start, delta_x_end, delta_y_end)
...
print(perfectCity([0.8, 1], [0.1, 0.1]))
print(perfectCity([0, 0], [0, 0]))
print(perfectCity([0, 1], [0, 2]))
print(perfectCity([1.2, 4.5], [0, 1]))